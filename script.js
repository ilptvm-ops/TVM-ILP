const ASSOCIATES = [
  "Tushar Shahaji Naik","Parnitha Sudha","Adiraju Anshita","Sahil Ajit Phadke","Debdwaipayan Biswas","Pujitha Reddy Bosa","Suryanarayanan R","Muskan Agarwal","Aneena Thasneem C A",
  "Sumith Sai Koraboina","Vs Barath","Ganesh D","Pranav Kapisway",
  "Gopi Venkata Mutya Akhil Polisetty","Anshi Patel","Dharshika S","Sairam Lokesh Devagudi",
  "Hardik S Shah","Harsh Pavan Kumar Soni","Abhishek H","Sakshi Pravin Shelar",
  ...
  "Pratiksha Vishnu Gangane","Sirisanjana Bonagam","Pratyush Prabal",
  "Kamalakannan S","Ameya Tamhane","Arjun Kireeti Tulasi",
  "Madhav Chowdary Prathapaneni","Sumeet Padhan","V Mithun",
  "Vikash Choudhary","Venkata Sai Kesav Gainedi","Adwaith Anil",
